export default function TeamCard({ group, getRandomAvatar }) {
  ...
  //h-80 w-[22rem]
  return (
    <div className="flex flex-col justify-around  h-[400px] w-[400px] shadow-[0_0px_20px_-5px_white] font-normal max-w-sm bg-[#1a1e1f] text-white rounded-2xl">
      <div className="bg-[#070e0e] rounded-2xl  flex flex-col items-center justify-center flex-2 h-2/3 p-2">
        <svg
          className=" h-20 w-20 text-[#36BCBA] shadow-[0_0px_30px_-5px_white] rounded-full"
